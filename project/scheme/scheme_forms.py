...
def do_if_form(expressions, env):
    ...
    if is_scheme_true(scheme_eval(expressions.first, env)):
        return scheme_eval(expressions.rest.first, env, True)  # Problem EC 1
    elif len(expressions) == 3:
        return scheme_eval(expressions.rest.rest.first, env, True)  # Problem EC 1
...
def do_and_form(expressions, env):
    ...
    if expressions is nil:
        ...
        return scheme_eval(expressions.first, env, True)  # Problem EC 1
    else:
        first_expr_value = scheme_eval(expressions.first, env)
        if is_scheme_true(first_expr_value):
            return do_and_form(expressions.rest, env)
        return first_expr_value
    # END PROBLEM 12
...
def do_or_form(expressions, env):
    ...
    if expressions is nil:
        ...
        first_expr_value = scheme_eval(expressions.first, env)
        if is_scheme_false(first_expr_value):
